...
void Controller::HandleInput1Player(bool &running, std::vector<std::shared_ptr<Snake>> snakes) const{
  SDL_Event e;
...
void Controller::HandleInput2Players(bool &running, std::vector<std::shared_ptr<Snake>> snakes) const {
  SDL_Event e;
  while (SDL_PollEvent(&e)) {
